...
import {Container, Row, Col, Table, Button, Modal, Image, Card} from 'react-bootstrap';
...
export default function Arvhivos() {
    ...
    return (
        <>
        {(docs === null || docs === undefined) ?  <Container fluid className="text-center py-3 " style={{ backgroundColor: "rgba(230,230,230,0.7)" }}>
            <Row>
                <Col className="col">
                    <hr />
                        ...
                        <Card className={"p-0 m-1"}>
                            ...
                            <Card.Footer>
                                {(docs.identificacionTutoradoAnexo6 === "")
                                    ? <Anexo6 />
                                    : <div className="alert alert-success"><button className="btn btn-success">VER ANEXO 6</button></div>
                                }
                            </Card.Footer>
                        </Card>
                        <Card className={"p-0 m-1"}>
                            ...
                            <Card.Footer>
                                {(docs.anexo8 === "entregado")
                                    ? <div className="alert alert-success"><button className="btn btn-success">VER ANEXO 8</button></div>
                        ...
                        <Card className={"p-0 m-1"}>
                            ...
                            <Card.Footer>
                                {(docs.cartillaImss === "")
                                    ...
                                    : <>
                                        <SubirDocumento name="Actualizar" nombre="CARTILLA DE SEGURO SOCIAL" tipo="imss" />
                        ...
                        <Card className={"p-0 m-1"}>
                            ...
                            <Card.Footer>
                                {(docs.certificadoPrepaBachiller === "")
                                    ? <SubirDocumento name="Subir" nombre="Certificado de bachilles / Preparatoria" tipo="certificado" />
                                    : <>
                                        <SubirDocumento name="Actualizar" nombre="Certificado de bachilles / Preparatoria" tipo="certificado" />
                                        <VerImagen nombre="Certificado de bachilles / Preparatoria" data={docs.certificadoPrepaBachiller}/>
                                    </>}
                            </Card.Footer>
                        </Card>
                        <Card className={"p-0 m-1"}>
                            ...
                            <Card.Footer>
                                {(docs.analisisFodaAnexo10 === "")
                                    ? <Anexo10 />
                                    : <div className="alert alert-success"><button className="btn btn-success">VER ANALISIS FODA</button></div>}
                            </Card.Footer>
                        </Card>
                        <Card className={"p-0 m-1"}>
                            <Card.Body>
...
function SubirDocumento(props) {
    ...
    return (<>
        <br/>
        <Button className={"btn btn-success mx-1 my-1"} onClick={handleShow}> {(props.name === "Subir" || props.name === "Actualizar")
            ? <BsFillCloudUploadFill/>
            : <BsFillCloudUploadFill/>
        }</Button>

        <Modal show={show} size="lg" onHide={handleClose} backdrop="static" aria-labelledby="contained-modal-title-vcenter" centered>
